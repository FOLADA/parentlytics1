...
export function Roadmap() {
  ...
  const phases = [
    ...
    },
    {
      phase: "Phase 3",
      status: "future",
      title: "Community & AI Enhancement",
      description: "Parent community features, advanced AI insights, and comprehensive analytics",
      features: [
        "Parent community and support groups",
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'current':
        return <Badge className="bg-emerald-100 text-emerald-800 border-emerald-200">Current</Badge>;
      case 'next':
        return <Badge className="bg-sky-100 text-sky-800 border-sky-200">Next</Badge>;
      case 'future':
        return <Badge className="bg-slate-100 text-slate-800 border-slate-200">Future</Badge>;
      default:
        return <Badge className="bg-slate-100 text-slate-800 border-slate-200">Future</Badge>;
    }
  };
