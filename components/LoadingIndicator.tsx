...
export default function LoadingIndicator({ message = "თქვენი პერსონალიზებული კვების გეგმის შექმნა..." }: LoadingIndicatorProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen space-y-6 -mt-24">
      {/* ანიმირებული ხატულები */}
      ...
      >
        ...
        <p className="text-gray-600">ჩვენი AI ნუტრიციოლოგი ქმნის სრულყოფილ კერძებს თქვენი ბავშვისთვის...</p>
      </motion.div>

      {/* ანიმირებული წერტილები */}
